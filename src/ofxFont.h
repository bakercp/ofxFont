...
//
//
//typedef ofxText::FTFont ofxFont;
//typedef ofxText::FTFontCache ofxFontCache;
//typedef ofxText::FTFontSettings ofxFontSettings;
//typedef ofxText::FTFontGlyph ofxFontGlyph;
